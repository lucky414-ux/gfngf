...
LLVMUNWIND_OPTS := $(CMAKE_COMMON) -DCMAKE_BUILD_TYPE=MinSizeRel -DLIBUNWIND_ENABLE_PEDANTIC=OFF -DLIBUNWIND_INCLUDE_DOCS=OFF -DLIBUNWIND_INCLUDE_TESTS=OFF -DLIBUNWIND_INSTALL_HEADERS=ON -DLIBUNWIND_ENABLE_ASSERTIONS=OFF -DLLVM_CONFIG_PATH=$(build_depsbindir)/llvm-config
